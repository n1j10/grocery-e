...
const Footer = () => {
  return (
    <footer className="bg-slate-100 dark:bg-gray-900 mt-10">
      <div className="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
        <div className="text-center flex flex-col items-center justify-center">
          ...
          <Button href="#" className="mt-8 inline-flex items-center justify-center rounded-full border
       border-indigo-600 px-12 py-3 text-sm font-medium text-white hover:bg-[#e6b800] hover:text-white">
            Get Started
          </Button>
        ...
        <div className="mt-16 border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24 dark:border-gray-800">
          ...
          <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
            <li>
              <Link href="#" rel="noreferrer" target="_blank" className="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
